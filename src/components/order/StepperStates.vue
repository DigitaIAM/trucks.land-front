      ...
      <ol class="relative text-gray-500 border-l-2 border-gray-500">
        <li class="mb-8 ms-6" v-for="eventDate in events" :key="eventDate.id">
          ...
          <template v-if="eventDate.kind == 'pick-up'">
            <span class="cursor-pointer" @click="selectPickup(eventDate)">
              <span
          ...
          <template v-if="eventDate.kind == 'change'">
            <span class="cursor-pointer" @click="selectChange(eventDate)">
              <span
          ...
          <template v-if="eventDate.kind == 'agreement'">
            <span class="cursor-pointer" @click="selectAgreement(eventDate)">
              <span
          ...
          <template v-if="eventDate.kind == 'expenses'">
            <span class="cursor-pointer" @click="selectExpenses(eventDate)">
              <span
